 ...
 * `~/.agent-bridge/secrets-getter` (always user-owned, never a symlink) so
...
export async function ensureSecretsGetterWrapper(
  ...
  if (platform === 'win32') {
    ...
    const content =
      `@echo off\r\n` +
      `rem Auto-generated by agent-bridge. Do not edit.\r\n` +
  ...
  const content =
    `#!/bin/sh\n` +
    `# Auto-generated by agent-bridge. Do not edit.\n` +
